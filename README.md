<h1 align="center">Hi , I'm Andrea Acosta <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<p align="center">
</p>
...
<picture>
  <img align="right" src="https://media1.tenor.com/m/GiUbb4qg_vwAAAAC/csharp-cat-programmer.gif" width="250px">
</picture>

<br><br>

- :school: I am a `Junior` studying `DAM` (Desarrollo de Aplicaciones Multiplataforma).
- :technologist: I love using software to solve real-world `problems`.
- :computer: I enjoy exploring `programming` and creating small projects.
- :student: I’m currently learning `Java`, `Python`, `HTML`, `CSS` and more.
- :nerd_face: Always `learning new things` and improving my skills.
- :thinking: I’m open to new `learning opportunities` and `collaboration`.
- :boom: You can check some of my projects here on [MY GITHUB](https://github.com/7oSkaaa).
